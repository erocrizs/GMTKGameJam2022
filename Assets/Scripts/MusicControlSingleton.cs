...
public class MusicControlSingleton : MonoBehaviour
{
    public static MusicControlSingleton instance; // Creates a static varible for a MusicControlScript instance
